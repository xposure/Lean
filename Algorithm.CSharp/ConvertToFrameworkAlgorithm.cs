...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ConvertToFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "4.85%"},
            {"Average Loss", "-4.22%"},
            {"Compounding Annual Return", "-3.121%"},
            {"Drawdown", "52.900%"},
            {"Expectancy", "-0.053"},
            {"Net Profit", "-29.461%"},
            {"Sharpe Ratio", "-0.078"},
            ...
            {"Estimated Monthly Alpha Value", "$-581425.5"},
            {"Total Accumulated Estimated Alpha Value", "$-77876290"},
            {"Mean Population Estimated Insight Value", "$-916191.7"},
            {"Mean Population Direction", "51.7647%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "48.2217%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "1634816729"}
        };
    }
}
