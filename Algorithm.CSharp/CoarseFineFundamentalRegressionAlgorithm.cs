...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CoarseFineFundamentalRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "1.17%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "32.571%"},
            {"Drawdown", "1.400%"},
            {"Expectancy", "0"},
            {"Net Profit", "1.165%"},
            {"Sharpe Ratio", "2.877"},
            {"Probabilistic Sharpe Ratio", "64.985%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "100%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.237"},
            ...
            {"Sortino Ratio", "27.334"},
            {"Return Over Maximum Drawdown", "24.009"},
