...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class EqualWeightingPortfolioConstructionModelFutureRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.91%"},
            {"Compounding Annual Return", "-99.784%"},
            {"Drawdown", "29.500%"},
            {"Expectancy", "-1"},
            {"Net Profit", "-7.613%"},
            {"Sharpe Ratio", "-0.606"},
            {"Probabilistic Sharpe Ratio", "34.647%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-13.921"},
            {"Beta", "6.521"},
            {"Annual Standard Deviation", "1.633"},
            {"Annual Variance", "2.668"},
            {"Information Ratio", "-2.065"},
            {"Tracking Error", "1.439"},
            {"Treynor Ratio", "-0.152"},
            {"Total Fees", "$33.30"},
            {"Fitness Score", "0.079"},
            {"Kelly Criterion Estimate", "-9.474"},
            {"Kelly Criterion Probability Value", "0.608"},
            {"Sortino Ratio", "-4.654"},
            {"Return Over Maximum Drawdown", "-5.2"},
            ...
            {"Estimated Monthly Alpha Value", "$-127.6769"},
            {"Total Accumulated Estimated Alpha Value", "$-20.7475"},
            {"Mean Population Estimated Insight Value", "$-2.593438"},
            {"Mean Population Direction", "25%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "25.058%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "1291753543"}
        };
    }
}
