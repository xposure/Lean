...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SectorWeightingFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Sortino Ratio", "-2.57"},
            {"Return Over Maximum Drawdown", "-25.887"},
            ...
            {"Estimated Monthly Alpha Value", "$-323068.4"},
            {"Total Accumulated Estimated Alpha Value", "$-23332.72"},
            {"Mean Population Estimated Insight Value", "$-7777.574"},
            {"Mean Population Direction", "33.3333%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "33.3333%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-1867634921"}
        };
    }
}
