...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AddAlphaModelAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.86%"},
            {"Average Loss", "-0.27%"},
            {"Compounding Annual Return", "184.516%"},
            {"Drawdown", "1.700%"},
            {"Expectancy", "1.796"},
            {"Net Profit", "1.443%"},
            {"Sharpe Ratio", "4.02"},
            {"Probabilistic Sharpe Ratio", "59.643%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            ...
            {"Sortino Ratio", "12.446"},
            {"Return Over Maximum Drawdown", "106.453"},
            ...
            {"Long/Short Ratio", "0%"},
            {"Estimated Monthly Alpha Value", "$19385932.6234"},
            {"Total Accumulated Estimated Alpha Value", "$3338688.3962"},
            {"Mean Population Estimated Insight Value", "$1112896.1321"},
            {"Mean Population Direction", "100%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "100%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "552597797"}
        };
    }
}
