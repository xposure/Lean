...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UniverseUnchangedRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.01%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "-5.429%"},
            {"Drawdown", "2.100%"},
            {"Expectancy", "1.166"},
            {"Net Profit", "-0.214%"},
            {"Sharpe Ratio", "-0.26"},
            {"Probabilistic Sharpe Ratio", "39.664%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            {"Profit-Loss Ratio", "3.33"},
            {"Alpha", "-0.049"},
            {"Beta", "-0.067"},
            ...
            {"Sortino Ratio", "-0.801"},
            {"Return Over Maximum Drawdown", "-2.567"},
            ...
            {"Estimated Monthly Alpha Value", "$-7001.962"},
            {"Total Accumulated Estimated Alpha Value", "$-3306.482"},
            {"Mean Population Estimated Insight Value", "$-165.3241"},
