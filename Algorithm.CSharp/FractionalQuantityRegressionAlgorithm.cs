...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class FractionalQuantityRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.63%"},
            {"Average Loss", "-2.41%"},
            {"Compounding Annual Return", "77.276%"},
            {"Drawdown", "6.500%"},
            {"Expectancy", "-0.161"},
            {"Net Profit", "0.629%"},
            {"Sharpe Ratio", "1.783"},
            {"Probabilistic Sharpe Ratio", "50.367%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            {"Profit-Loss Ratio", "0.26"},
            {"Alpha", "0"},
            {"Beta", "0"},
            {"Annual Standard Deviation", "0.862"},
            {"Annual Variance", "0.742"},
            {"Information Ratio", "1.783"},
            {"Tracking Error", "0.862"},
            {"Treynor Ratio", "0"},
            {"Total Fees", "$2428.88"},
            {"Fitness Score", "0.849"},
            ...
            {"Sortino Ratio", "1.519"},
            {"Return Over Maximum Drawdown", "11.912"},
            {"Portfolio Turnover", "1.996"},
