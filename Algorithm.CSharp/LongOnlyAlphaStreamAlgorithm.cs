...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class LongOnlyAlphaStreamAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.99%"},
            {"Average Loss", "-0.60%"},
            {"Compounding Annual Return", "216.702%"},
            {"Drawdown", "2.300%"},
            {"Expectancy", "0.318"},
            {"Net Profit", "1.485%"},
            {"Sharpe Ratio", "7.299"},
            {"Probabilistic Sharpe Ratio", "64.959%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            ...
            {"Return Over Maximum Drawdown", "68.745"},
            ...
            {"Estimated Monthly Alpha Value", "$71152.8210"},
            {"Total Accumulated Estimated Alpha Value", "$11463.5101"},
            {"Mean Population Estimated Insight Value", "$1432.9388"},
            {"Mean Population Direction", "62.5%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "73.0394%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "-875376728"}
        };
    }
}
