...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateFuturesFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "0%"},
            {"Compounding Annual Return", "-92.773%"},
            {"Drawdown", "5.000%"},
            {"Expectancy", "0"},
            {"Net Profit", "-3.332%"},
            {"Sharpe Ratio", "-7.816"},
            {"Probabilistic Sharpe Ratio", "0.197%"},
            {"Loss Rate", "0%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-1.363"},
            ...
            {"Information Ratio", "-14.946"},
            {"Tracking Error", "0.19"},
            {"Treynor Ratio", "-3.325"},
            {"Total Fees", "$3.70"},
            {"Fitness Score", "0.009"},
            {"Kelly Criterion Estimate", "-113.153"},
            {"Kelly Criterion Probability Value", "0.671"},
            {"Sortino Ratio", "-8.41"},
            {"Return Over Maximum Drawdown", "-35.158"},
            ...
            {"Estimated Monthly Alpha Value", "$-168.1723"},
            {"Total Accumulated Estimated Alpha Value", "$-27.328"},
            {"Mean Population Estimated Insight Value", "$-5.4656"},
