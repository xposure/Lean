...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class NoMarginCallExpectedRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "2.44%"},
            {"Average Loss", "-1.97%"},
            {"Compounding Annual Return", "9649.416%"},
            {"Drawdown", "9.800%"},
            {"Expectancy", "0.346"},
            {"Net Profit", "6.030%"},
            {"Sharpe Ratio", "42.905"},
            ...
            {"Annual Variance", "0.694"},
            {"Information Ratio", "54.99"},
            ...
            {"Return Over Maximum Drawdown", "108.853"},
            {"Portfolio Turnover", "7.206"},
