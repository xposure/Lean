...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class CompositeAlphaModelFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.01%"},
            {"Average Loss", "-0.40%"},
            {"Compounding Annual Return", "1145.074%"},
            {"Drawdown", "1.800%"},
            {"Expectancy", "-0.319"},
            {"Net Profit", "3.277%"},
            {"Sharpe Ratio", "23.524"},
            {"Probabilistic Sharpe Ratio", "80.509%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            ...
            {"Sortino Ratio", "148.299"},
            {"Return Over Maximum Drawdown", "1490.319"},
