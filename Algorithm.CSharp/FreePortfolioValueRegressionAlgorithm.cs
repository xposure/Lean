...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class FreePortfolioValueRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Estimated Monthly Alpha Value", "$1132445.2286"},
            {"Total Accumulated Estimated Alpha Value", "$142582718.4866"},
            {"Mean Population Estimated Insight Value", "$54776.3037"},
