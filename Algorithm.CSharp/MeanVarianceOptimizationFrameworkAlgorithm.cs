...
namespace QuantConnect.Algorithm.CSharp
{
    public class MeanVarianceOptimizationFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.14%"},
            {"Average Loss", "-0.78%"},
            {"Compounding Annual Return", "516.545%"},
            {"Drawdown", "1.700%"},
            {"Expectancy", "-0.295"},
            {"Net Profit", "2.523%"},
            {"Sharpe Ratio", "14.172"},
            {"Probabilistic Sharpe Ratio", "75.317%"},
            {"Loss Rate", "40%"},
            {"Win Rate", "60%"},
            ...
            {"Sortino Ratio", "39.9"},
            {"Return Over Maximum Drawdown", "439.082"},
            {"Portfolio Turnover", "0.715"},
