...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class BasicTemplateOptionsFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Total Fees", "$3.00"},
            {"Fitness Score", "0"},
            {"Kelly Criterion Estimate", "0.329"},
            ...
            {"Estimated Monthly Alpha Value", "$146.6427"},
            {"Total Accumulated Estimated Alpha Value", "$8.9615"},
            {"Mean Population Estimated Insight Value", "$0.3733958"},
