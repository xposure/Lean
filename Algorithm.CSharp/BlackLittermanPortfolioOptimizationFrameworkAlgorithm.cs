...
namespace QuantConnect.Algorithm.CSharp
{
    public class BlackLittermanPortfolioOptimizationFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.17%"},
            {"Compounding Annual Return", "62.823%"},
            {"Drawdown", "1.100%"},
            {"Expectancy", "-1"},
            {"Net Profit", "0.670%"},
            {"Sharpe Ratio", "3.523"},
            {"Probabilistic Sharpe Ratio", "59.228%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "-0.382"},
            ...
            {"Return Over Maximum Drawdown", "65.994"},
            ...
            {"Estimated Monthly Alpha Value", "$45135.9147"},
            {"Total Accumulated Estimated Alpha Value", "$7773.4075"},
            {"Mean Population Estimated Insight Value", "$555.2434"},
