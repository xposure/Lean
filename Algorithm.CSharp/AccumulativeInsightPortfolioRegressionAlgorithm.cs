...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class AccumulativeInsightPortfolioRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.00%"},
            {"Average Loss", "0.00%"},
            {"Compounding Annual Return", "-12.385%"},
            {"Drawdown", "0.200%"},
            {"Expectancy", "-0.586"},
            {"Net Profit", "-0.169%"},
            {"Sharpe Ratio", "-9.558"},
            {"Probabilistic Sharpe Ratio", "13.393%"},
            {"Loss Rate", "79%"},
            {"Win Rate", "21%"},
            ...
            {"Sortino Ratio", "-21.578"},
            {"Return Over Maximum Drawdown", "-77.987"},
            {"Portfolio Turnover", "1.149"},
