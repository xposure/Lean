...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OrderSubmissionDataRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.83%"},
            {"Average Loss", "-0.90%"},
            {"Compounding Annual Return", "275.521%"},
            {"Drawdown", "3.200%"},
            {"Expectancy", "0.204"},
            {"Net Profit", "1.721%"},
            {"Sharpe Ratio", "11.449"},
            {"Probabilistic Sharpe Ratio", "67.020%"},
            {"Loss Rate", "38%"},
            {"Win Rate", "62%"},
            ...
            {"Sortino Ratio", "10.319"},
            {"Return Over Maximum Drawdown", "48.985"},
            {"Portfolio Turnover", "2.588"},
