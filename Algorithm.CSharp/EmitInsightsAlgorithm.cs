...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class EmitInsightsAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.94%"},
            {"Average Loss", "-0.98%"},
            {"Compounding Annual Return", "-47.211%"},
            {"Drawdown", "1.200%"},
            {"Expectancy", "-0.020"},
            {"Net Profit", "-0.871%"},
            {"Sharpe Ratio", "-2.306"},
            {"Probabilistic Sharpe Ratio", "31.809%"},
            {"Loss Rate", "50%"},
            {"Win Rate", "50%"},
            ...
            {"Sortino Ratio", "-29.587"},
            {"Return Over Maximum Drawdown", "-40.154"},
            ...
            {"Estimated Monthly Alpha Value", "$18637265.2878"},
            {"Total Accumulated Estimated Alpha Value", "$3209751.2440"},
            {"Mean Population Estimated Insight Value", "$802437.8110"},
            {"Mean Population Direction", "50%"},
            {"Mean Population Magnitude", "50%"},
            {"Rolling Averaged Population Direction", "50%"},
            {"Rolling Averaged Population Magnitude", "50%"},
            {"OrderListHash", "-1876824322"}
        };
    }
}
