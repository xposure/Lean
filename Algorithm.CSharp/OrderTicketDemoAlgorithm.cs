...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class OrderTicketDemoAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "92.316%"},
            {"Drawdown", "0.100%"},
            {"Expectancy", "-1"},
            {"Net Profit", "0.840%"},
            {"Sharpe Ratio", "12.949"},
            {"Probabilistic Sharpe Ratio", "99.061%"},
            {"Loss Rate", "100%"},
            {"Win Rate", "0%"},
            {"Profit-Loss Ratio", "0"},
            {"Alpha", "0.249"},
            ...
            {"Sortino Ratio", "152.725"},
            {"Return Over Maximum Drawdown", "1193.808"},
