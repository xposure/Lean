...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class VolumeWeightedAveragePriceExecutionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.04%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "474.510%"},
            {"Drawdown", "1.200%"},
            {"Expectancy", "2.415"},
            {"Net Profit", "2.261%"},
            {"Sharpe Ratio", "12.738"},
            {"Probabilistic Sharpe Ratio", "71.604%"},
            {"Loss Rate", "32%"},
            {"Win Rate", "68%"},
            {"Profit-Loss Ratio", "4.03"},
            {"Alpha", "1.112"},
            {"Beta", "1.045"},
            {"Annual Standard Deviation", "0.25"},
            {"Annual Variance", "0.062"},
            {"Information Ratio", "13.045"},
            ...
            {"Return Over Maximum Drawdown", "540.84"},
