...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class EquityTradeAndQuotesRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.12%"},
            {"Average Loss", "-0.10%"},
            {"Compounding Annual Return", "-86.493%"},
            {"Drawdown", "3.300%"},
            {"Expectancy", "-0.225"},
            {"Net Profit", "-2.705%"},
            {"Sharpe Ratio", "-4.958"},
            {"Probabilistic Sharpe Ratio", "1.086%"},
            {"Loss Rate", "65%"},
            {"Win Rate", "35%"},
            ...
            {"Sortino Ratio", "-6.961"},
            {"Return Over Maximum Drawdown", "-31.973"},
            {"Portfolio Turnover", "49.952"},
