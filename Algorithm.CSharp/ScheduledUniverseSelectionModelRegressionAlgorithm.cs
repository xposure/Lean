...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ScheduledUniverseSelectionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.16%"},
            {"Average Loss", "-0.09%"},
            {"Compounding Annual Return", "50.214%"},
            {"Drawdown", "1.100%"},
            {"Expectancy", "0.833"},
            {"Net Profit", "3.689%"},
            {"Sharpe Ratio", "7.031"},
            {"Probabilistic Sharpe Ratio", "99.082%"},
            {"Loss Rate", "33%"},
            {"Win Rate", "67%"},
            ...
            {"Sortino Ratio", "43.271"},
            {"Return Over Maximum Drawdown", "123.888"},
            ...
            {"Estimated Monthly Alpha Value", "$872921.5680"},
            {"Total Accumulated Estimated Alpha Value", "$951726.9874"},
            {"Mean Population Estimated Insight Value", "$17957.1130"},
            {"Mean Population Direction", "58.4906%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "55.0223%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "1897274469"}
        };
    }
}
