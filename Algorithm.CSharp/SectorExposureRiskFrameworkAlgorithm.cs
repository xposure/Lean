...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SectorExposureRiskFrameworkAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.08%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "-35.063%"},
            {"Drawdown", "2.100%"},
            {"Expectancy", "1.410"},
            {"Net Profit", "-1.642%"},
            {"Sharpe Ratio", "-3.58"},
            {"Probabilistic Sharpe Ratio", "9.140%"},
            {"Loss Rate", "62%"},
            {"Win Rate", "38%"},
            ...
            {"Sortino Ratio", "-4.519"},
            {"Return Over Maximum Drawdown", "-16.315"},
            ...
            {"Estimated Monthly Alpha Value", "$-3207287"},
            {"Total Accumulated Estimated Alpha Value", "$-1514552"},
            {"Mean Population Estimated Insight Value", "$-60582.09"},
            {"Mean Population Direction", "32%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "57.5578%"},
            {"Rolling Averaged Population Magnitude", "0%"},
            {"OrderListHash", "2116054366"}
        };
    }
}
