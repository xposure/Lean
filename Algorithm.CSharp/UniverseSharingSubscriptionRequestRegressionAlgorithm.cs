...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class UniverseSharingSubscriptionRequestRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.68%"},
            {"Average Loss", "-0.14%"},
            {"Compounding Annual Return", "35.532%"},
            {"Drawdown", "1.000%"},
            {"Expectancy", "3.197"},
            {"Net Profit", "2.530%"},
            {"Sharpe Ratio", "3.547"},
            {"Probabilistic Sharpe Ratio", "76.151%"},
            {"Loss Rate", "29%"},
            {"Win Rate", "71%"},
            {"Profit-Loss Ratio", "4.88"},
            {"Alpha", "0.256"},
            {"Beta", "0.045"},
            {"Annual Standard Deviation", "0.078"},
            {"Annual Variance", "0.006"},
            {"Information Ratio", "-1.535"},
            ...
            {"Sortino Ratio", "7.574"},
            {"Return Over Maximum Drawdown", "34.896"},
